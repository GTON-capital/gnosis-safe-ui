...
export const INTERCOM_ID = IS_PRODUCTION
  ...
  : 'plssl1fl'
export const BEAMER_ID = IS_PRODUCTION
  ? process.env.REACT_APP_BEAMER_ID
  : 'ehlRMhQi41258'
export const SENTRY_DSN = process.env.REACT_APP_SENTRY_DSN || ''
export const PORTIS_ID =
  process.env.REACT_APP_PORTIS_ID ?? '852b763d-f28b-4463-80cb-846d7ec5806b'
export const FORTMATIC_KEY =
  process.env.REACT_APP_FORTMATIC_KEY ?? 'pk_test_CAD437AA29BE0A40'
export const INFURA_TOKEN = process.env.REACT_APP_INFURA_TOKEN || ''
export const SAFE_APPS_RPC_TOKEN =
  process.env.REACT_APP_SAFE_APPS_RPC_INFURA_TOKEN || ''
...
export const COLLECTIBLES_SOURCE =
  process.env.REACT_APP_COLLECTIBLES_SOURCE || 'Gnosis'
export const SAFE_POLLING_INTERVAL =
  process.env.NODE_ENV === 'test' ? 4500 : 15000
export const ETHERSCAN_API_KEY = process.env.REACT_APP_ETHERSCAN_API_KEY || ''
export const ETHGASSTATION_API_KEY = process.env.REACT_APP_ETHGASSTATION_API_KEY
export const IPFS_GATEWAY = process.env.REACT_APP_IPFS_GATEWAY
export const WC_BRIDGE =
  process.env.REACT_APP_WC_BRIDGE || 'https://safe-walletconnect.gnosis.io/'
...
export const GOOGLE_TAG_MANAGER_AUTH_LIVE =
  process.env.REACT_APP_GOOGLE_TAG_MANAGER_LIVE_AUTH || ''
...
export const GOOGLE_TAG_MANAGER_DEVELOPMENT_AUTH =
  process.env.REACT_APP_GOOGLE_TAG_MANAGER_DEVELOPMENT_AUTH || ''
...
export const TENDERLY_PROJECT_NAME =
  process.env.REACT_APP_TENDERLY_PROJECT_NAME || ''
  ...
  try {
    return (
      localStorage.getItem(
        `${LS_NAMESPACE}${LS_SEPARATOR}${LS_USE_PROD_CGW}`,
      ) === 'true'
    )
  } catch (e) {
    return false
